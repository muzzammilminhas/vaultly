...
enum _Stage { camera, reviewing, error }

/// Capture a document via camera or gallery, then crop/rotate it before
/// confirming. Pops with the final encoded JPEG bytes, or null if cancelled.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_stage == _Stage.reviewing ? 'Adjust crop' : 'Scan document'),
      ),
      body: switch (_stage) {
